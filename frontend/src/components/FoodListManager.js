              ...
              {foodList.map((food, index) => {
                return (
                 ...
                 <div className='px-8 py-6 '>
                  ...
                  <button className='float-end bg-sky-950 py-3 px-2 ml-12 mr-2 mb-2 rounded-full text-white transition hover:scale-105 hover:bg-blue-950 ease-out duration-150'  onClick={()=> handleDelete(food.foodcode)}>Delete Food </button>
