...
function DeleteEstablishment (props) {
    ...
    return(
        ...
        <div className='w-11/12 self-center'>
            ...
            <p className=' text-base mb-2 text-sky-950'>Deleting this establishment means all data will be deleted. This includes food items and all reviews associated.</p>
