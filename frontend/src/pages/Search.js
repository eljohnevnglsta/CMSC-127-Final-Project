...
function Search() {
  ...
  //shows the specific food when there is input in the search, shows all foods otherwise
  useEffect(() => {
    if (foodSearch) {
      allFood();
    } else {
  ...
  //shows the specific establshment when there is input in the search, shows all establshments otherwise
  useEffect(() => {
    if (search.length !== 0) {
      if (!foodSearch) {
  ...
  //invokes the search food backend by passing the keyword (came from user input)
  ...
  //shows food based on the filters set
    ...
    <div className="search-container">
      <div className="text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:text-gray-400 dark:border-gray-700 my-7 pl-8">
        <div className="flex flex-wrap -mb-px">
          <button
            className="inline-block p-4 font-semibold border-b-2 border-transparent rounded-t-lg hover:border-b-sky-950 hover:text-gray-600 text-sky-950 px-6"
            onClick={() => {
              setFoodSearch(false);
              setResults([]);
              setError(false);
      ...
      <form className="max-w-md mx-auto mt-10">
        <div class="relative">
          ...
          <input
            ...
            placeholder="Search food item or establishment..."
            onChange={(e) => {
          ...
          {search.length > 0 ? (
              ...
              <div className="w-2/4 shadow-lg">
                {results.length > 0 ? (
                  <>
                    ...
                    {results.map((res) => {
                      return (
                        <Link to={`/food-establishment/${res.name}`}>
                          <h3 className="font-bold px-8 py-2 text-base mb-2 text-gray-500 hover:text-sky-950">
                            {res.name}
                          </h3>{" "}
                        </Link>
                      );
            ...
            <>
              <div className="my-10 overflow-hidden px-8 mx-10 min-h-screen round shadow-lg ">
                <h1 className="font-bold text-4xl my-2 text-sky-950 mb-4">
            ...
            <div className="my-10 overflow-hidden px-8 mx-10 min-h-screen round shadow-lg ">
              ...
              <div className="border-sky-950 border-b mb-8 flex items-center pb-2">
                <div className="flex justify-end items-center w-full px-4 ">
                  ...
                  />
                  <button
                    className="font-semibold hover:shadow round px-4"
