...
function UpdateEstablishment(props) {
  ...
  //gets the details of the establishment and loads in into the variables
  useEffect(() => {
  ...
  //updates the establishmet by passing the newly edited varaibles into it
      ...
      <div className="bg-orange-50 rounded-lg p-6 w-full max-h-xl max-w-3xl">
        <div className="flex justify-between items-center mb-4">
          <div className="w-full">
            ...
            <h1 className="font-semibold text-lg mb-2 text-sky-950">
              {businessDetails.name}
            </h1>
            <p className="text-lg mb-2 text-sky-950">
              {" "}
            ...
            <form onSubmit={handleEditEstablishment}>
              <div className=" text-lg pb-2">
                ...
                <br />
                <input
                  className="p-4 border-slate-300 rounded-lg border h-10 focus:shadow-md border-sky-950 py-2 text-lg ml-4 w-11/12 text-sky-950"
                  type="text"
                  required
                  value={street}
